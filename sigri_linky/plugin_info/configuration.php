...
<form class="form-horizontal">
    <fieldset>
        ...
        <div class="col-lg-5">
          ...
          Si vous n'avaez pas encore de compte Enedis, vous pouvez l'ouvrir 
          ...
          Ce plugin historise vos donnees, vous devez avoir donc un equiepement non visible pour ne pas l'avoir en dashboard.<br>
